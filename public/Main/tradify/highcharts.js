...
(function (T, L) {
    ...
    a.Fx.prototype = {
      dSetter: function () {
        ...
        if (1 === w) l = this.toD;
          ...
          for (; p--; )
            (v = parseFloat(a[p])),
              (l[p] = isNaN(v) ? m[p] : w * parseFloat(m[p] - v) + v);
        else l = m;
        ...
        function w(a) {
          ...
          for (t = a.length; t--; )
            (g = 'M' === a[t] || 'L' === a[t]),
              ...
              g &&
                b &&
                a.splice(t + 1, 0, a[t + 1], a[t + 2], a[t + 1], a[t + 2]);
        }
        function p(a, c) {
          for (; a.length < g; ) {
            a[0] = c[g - a.length];
    ...
    a.numberFormat = function (r, m, l, w) {
      ...
      -1 === m
        ...
        ? m &&
          ...
          ((B = m + +c[1]),
          0 <= B
            ? ((c[0] = (+c[0]).toExponential(B).split('e')[0]), (m = B))
            : ((c[0] = c[0].split('.')[0] || 0),
              (r = 20 > m ? (c[0] * Math.pow(10, c[1])).toFixed(m) : 0),
              (c[1] = 0)))
        : (m = 2);
      e = (
      ...
      init: function (l) {
        ...
        if (
          ...
          (l &&
            ...
            7 === m
              ? (p = [(l & 16711680) >> 16, (l & 65280) >> 8, l & 255, 1])
              : 4 === m &&
                (p = [
                  ((l & 3840) >> 4) | ((l & 3840) >> 8),
                  ((l & 240) >> 4) | (l & 240),
  ...
  (function (a) {
    ...
    g(C.prototype, {
        ...
        f &&
          ...
          n[G]
            ...
            : ((c.id = y = a.uniqueKey()),
              ...
              b(t, function (h) {
                0 === h[1].indexOf('rgba')
                  ? ((g = a.color(h[1])), (u = g.get('rgb')), (A = g.get('a')))
                  : ((u = h[1]), (A = 1));
                h = K.createElement('stop')
                  .attr({ offset: h[0], 'stop-color': u, 'stop-opacity': A })
                  .add(q);
                q.stops.push(h);
              })),
          (k = 'url(' + K.url + '#' + y + ')'),
      ...
      applyTextOutline: function (h) {
        ...
        -1 !== h.indexOf('contrast') &&
          (h = h.replace(/contrast/g, this.renderer.getContrast(K.style.fill)));
        h = h.split(' ');
        x = h[h.length - 1];
      ...
      attr: function (a, h, d, x) {
        ...
        'string' === typeof a &&
          ...
          ((K = a), (a = {}), (a[K] = h));
        'string' === typeof a
          ? (f = (this[a + 'Getter'] || this._defaultGetter).call(this, a, g))
          : (z(
              a,
              function (h, d) {
                c = !1;
                ...
                !this.rotation ||
                  ...
                  (this.doTransform = !0);
                c ||
                  ((e = this[d + 'Setter'] || this._defaultSetter),
                  e.call(this, h, d, g),
                  this.shadows &&
          ...
          : b &&
            a.push(
              'rotate(' +
                ...
                ' ' +
                G(this.rotationOriginY, c.getAttribute('y') || 0) +
                ')'
            );
      ...
      align: function (a, h, d) {
        ...
        if (a) {
          if (
            ((this.alignOptions = a), (this.alignByTranslate = h), !d || H(d))
          )
      ...
      getBBox: function (a, h) {
        ...
        B(z) &&
          ...
          (A += ['', h || 0, n, K && K.width, K && K.textOverflow].join()));
        A && !a && (d = t[A]);
        if (!d) {
      ...
      destroy: function () {
        ...
        g &&
          x &&
          (b(x.querySelectorAll('[clip-path],[CLIP-PATH]'), function (a) {
        ...
        if (!a) this.destroyShadows();
          ...
          for (g = 1; g <= e; g++)
            (b = f.cloneNode(0)),
              ...
              d &&
                (m(b, 'height', Math.max(m(b, 'height') - c, 0)),
                (b.cutHeight = c)),
              h
                ? h.element.appendChild(b)
                : f.parentNode && f.parentNode.insertBefore(b, f),
              x.push(b);
          this.shadows = x;
        }
        return this;
      ...
      zIndexSetter: function (a, d) {
        ...
        var z;
        B(a) &&
          ((c.zIndex = a), (a = +a), this[d] === a && (f = !1), (this[d] = a));
        if (f) {
    ...
    C.prototype['stroke-widthSetter'] = C.prototype.strokeSetter = function (
      ...
      this.stroke && this['stroke-width']
        ? (C.prototype.fillSetter.call(this, this.stroke, 'stroke', d),
    ...
    g(E.prototype, {
      ...
      buildText: function (a) {
        var d = a.element,
          ...
          w = function (a) {
            ...
            return J
              ? h(J)
              : x.fontMetrics(g, a.getAttribute('style') ? a : d).h;
          },
          r = function (a, h) {
            z(x.escapes, function (d, x) {
              (h && -1 !== u(d, h)) ||
                (a = a.toString().replace(new RegExp(d, 'g'), x));
            });
            return a;
          };
        ...
        if (v !== a.textCache) {
          ...
          c || N || H || K || -1 !== f.indexOf(' ')
            ? ((n = /<.*class="([^"]+)".*>/),
                    ...
                    if (' ' !== h) {
                      ...
                      if (K) {
                        ...
                        var G = [],
                          ...
                          N = a.rotation;
                        for (
                          H && (y = x.applyEllipsis(a, z, h, K));
                          !H && t && (b.length || G.length);

                        )
                          (a.rotation = 0),
                            (D = x.getSpanWidth(a, z)),
                            (h = D > K),
                            void 0 === y && (y = h),
                            h && 1 !== b.length
              ...
              y && a.attr('title', r(a.textStr, ['\x26lt;', '\x26gt;'])),
              D && D.removeChild(d),
      ...
      rect: function (a, h, d, x, b, g) {
        ...
        a = y(a)
          ...
          : void 0 === a
          ? {}
          : { x: a, y: h, width: Math.max(d, 0), height: Math.max(x, 0) };
      ...
      symbol: function (a, h, d, x, f, c) {
        var e = this,
          ...
          u =
            B(h) &&
            A &&
            A.call(this.symbols, Math.round(h), Math.round(d), x, f, c),
          y,
          I;
        A
          ? ((z = this.path(u)),
          ...
          : q &&
            ...
            b(['width', 'height'], function (a) {
              z[a + 'Setter'] = function (a, h) {
                ...
                this[h] = a;
                B(x) &&
                  (this.element && this.element.setAttribute(h, x),
                  this.alignByTranslate ||
                    ((d[b] = ((this[h] || 0) - x) / 2), this.attr(d)));
              };
            }),
            B(h) && z.attr({ x: h, y: d }),
            (z.isImg = !0),
      ...
      symbols: {
        ...
        arc: function (a, h, d, x, b) {
          var f = b.start,
            ...
            e = b.end - 0.001;
          d = b.innerR;
          x = G(b.open, 0.001 > Math.abs(b.end - b.start - 2 * Math.PI));
          var z = Math.cos(f),
            n = Math.sin(f),
            q = Math.cos(e),
            e = Math.sin(e);
        ...
        callout: function (a, h, d, x, b) {
          ...
          c && c > d
            ...
            : c && 0 > c
            ? b > h + g && b < h + x - g
              ? e.splice(33, 3, 'L', a, b + 6, a - 6, b, a, b - 6, a, h + f)
              : e.splice(33, 3, 'L', a, x / 2, c, b, a, x / 2, a, h + f)
            : b && b > x && c > a + g && c < a + d - g
            ? e.splice(
                23,
                3,
            ...
            : b &&
              ...
              c > a + g &&
              c < a + d - g &&
              e.splice(3, 3, 'L', c - 6, h, c, h - 6, c + 6, h, d - f, h);
          return e;
        },
      },
      ...
      getTimeTicks: function (a, v, B, e) {
        ...
        if (C(v)) {
          c.set(
            'Milliseconds',
            n,
            t >= l.second ? 0 : f * Math.floor(c.get('Milliseconds', n) / f)
          );
          t >= l.second &&
            c.set(
              'Seconds',
              n,
              t >= l.minute ? 0 : f * Math.floor(c.get('Seconds', n) / f)
            );
          t >= l.minute &&
            c.set(
              'Minutes',
              n,
              t >= l.hour ? 0 : f * Math.floor(c.get('Minutes', n) / f)
            );
          t >= l.hour &&
            c.set(
              'Hours',
              n,
              t >= l.day ? 0 : f * Math.floor(c.get('Hours', n) / f)
            );
          t >= l.day &&
            c.set(
              'Date',
              n,
              t >= l.month ? 1 : f * Math.floor(c.get('Date', n) / f)
            );
          t >= l.month &&
            (c.set(
              'Month',
              n,
              t >= l.year ? 0 : f * Math.floor(c.get('Month', n) / f)
            ),
            (g = c.get('FullYear', n)));
          t >= l.year && c.set('FullYear', n, g - (g % f));
          t === l.week &&
            c.set('Date', n, c.get('Date', n) - c.get('Day', n) + m(e, 1));
          g = c.get('FullYear', n);
          e = c.get('Month', n);
          var D = c.get('Date', n),
            q = c.get('Hours', n);
              ...
              (n =
                t === l.year
                  ...
                  ? u && t === l.hour && 1 < f
                    ...
                    : n + t * f
                  : c.makeTime(g, e, D + v * f * (t === l.day ? 1 : 7))),
              v++;
          k.push(n);
          t <= l.hour &&
            1e4 > k.length &&
  ...
  (function (a) {
    ...
    a.Tick.prototype = {
      addLabel: function () {
        ...
        a.isDatetimeAxis &&
          g &&
          (f = v.dateTimeLabelFormats[g.higherRanks[k] || g.unitName]);
        this.isFirst = n;
        this.isLast = t;
      ...
      handleOverflow: function (a) {
        ...
        A &&
          ((y.width = A),
          (m.style || {}).textOverflow || (y.textOverflow = 'ellipsis'),
          g.css(y));
      },
      getPosition: function (l, m, B, e) {
        ...
        return {
          x: l
            ? a.correctFloat(c.translate(m + B, null, null, e) + c.transB)
            : c.left +
              c.offset +
              (c.opposite
                ? ((e && k.oldChartWidth) || k.chartWidth) - c.right - c.left
                : 0),
          y: l
            ? b - c.bottom + c.offset - (c.opposite ? c.height : 0)
            : a.correctFloat(b - c.translate(m + B, null, null, e) - c.transB),
        };
      },
        ...
        var n = this.axis,
          ...
          A =
            e || n.reserveSpaceDefault
              ? 0
              : -n.labelOffset * ('center' === n.labelAlign ? 0.5 : 1);
        E(q) ||
          (q =
            0 === n.side
              ? m.rotation
              ...
              : 2 === n.side
              ? D.y + 8
              : Math.cos(m.rotation * w) * (D.y - m.getBBox(!1, 0).height / 2));
  ...
  var da = (function (a) {
    ...
    a.extend(G.prototype, {
      ...
      init: function (a, d) {
        ...
        x.side =
          d.side || (x.horiz ? (x.opposite ? 0 : 2) : x.opposite ? 1 : 3);
        x.setOptions(d);
        var b = this.options,
          f = b.type;
              ...
              (x = h.xData),
                x.length &&
                  ...
                  u(h) ||
                    ...
                    ((x = n(x, u)), (h = r(x)), (f = F(x))),
                  x.length &&
                    ((a.dataMin = Math.min(H(a.dataMin, x[0], h), h)),
                    (a.dataMax = Math.max(H(a.dataMax, x[0], f), f))));
            else if (
              (h.getExtremes(),
              (f = h.dataMax),
              (h = h.dataMin),
      ...
      toPixels: function (a, d) {
        return (
          this.translate(a, !1, !this.horiz, null, !0) + (d ? 0 : this.pos)
        );
      },
        ...
        if (q && q / f < a.len / 3)
          if (a.isLog)
            e(this.paddedTicks, function (h, d, x) {
              d &&
                c.push.apply(c, a.getLogTickPositions(f, x[d - 1], x[d], !0));
            });
      ...
      adjustForMinRange: function () {
        ...
        b - d < this.minRange &&
          ...
          (b = r(b)),
          b - d < t && ((f[0] = b - t), (f[1] = H(a.min, b - t)), (d = F(f))));
        this.min = d;
        this.max = b;
      },
      getClosest: function () {
        ...
        0 < d.length &&
          ...
          e(this.series || [], function (a) {
            ...
            e(a.points, function (d, b) {
              ...
              d.options &&
                ((x = h.nameToX(d)),
                void 0 !== x && x !== d.x && ((d.x = x), (a.xData[b] = x)));
            });
          }));
      },
      setAxisTranslation: function (a) {
        ...
        if (t || q || b)
          (f = h.getClosest()),
            z
              ? ((c = z.minPointOffset), (g = z.pointRangePadding))
      ...
      setTickInterval: function (h) {
        ...
        !(J || d.axisPointRange || d.usePercentage || t) &&
          ...
          p(d.max) &&
          (z = d.max - d.min) &&
          (!p(r) && y && (d.min -= z * y), !p(C) && G && (d.max += z * G));
        ...
        d.tickInterval =
          d.min === d.max || void 0 === d.min || void 0 === d.max
            ? 1
            : t && !I && D === d.linkedParent.options.tickPixelInterval
        ...
        d.postProcessTickInterval &&
          (d.tickInterval = d.postProcessTickInterval(d.tickInterval));
        d.pointRange &&
          !I &&
      ...
      setAxisSize: function () {
        var d = this.chart,
          ...
          g = (this.width = Math.round(
            a.relativeLength(H(b.width, d.plotWidth - f[3] + f[1]), d.plotWidth)
          )),
      ...
      unsquish: function () {
        ...
        d
          ? (u =
              ...
              (p(z)
                ? [z]
                : c < H(a.autoRotationLimit, 80) && a.autoRotation)) &&
            e(u, function (a) {
              var d;
              if (a === z || (a && -90 <= a && 90 >= a))
          ...
          for (G = 'clip', q = b.length; !g && q--; )
            if (((I = b[q]), (I = f[I].label)))
              I.styles && 'ellipsis' === I.styles.textOverflow
                ...
                : I.textPxLength > z && I.css({ width: z + 'px' }),
                I.getBBox().height > this.len / b.length - (t.h - t.f) &&
                  (I.specificTextOverflow = 'ellipsis');
        n.rotation &&
          ((A = y > 0.5 * a.chartHeight ? 0.33 * a.chartHeight : a.chartHeight),
          u || (G = 'ellipsis'));
        if (
          (this.labelAlign = c.align || this.autoLabelAlign(this.labelRotation))
        )
        ...
        e(b, function (a) {
          ...
          d &&
            ...
            !A ||
              ...
              !(A < d.textPxLength || 'SPAN' === d.element.tagName) ||
              d.css({ width: A, textOverflow: d.specificTextOverflow || G }),
        ...
        if (b.hasData() || n)
          b.minorTickInterval &&
            ...
            t.length &&
              ...
              H &&
                (0 === b.min || b.single) &&
                (I[-1] || (I[-1] = new z(b, -1, null, !0)), I[-1].render(-1))),
            J &&
              e(t, function (d, h) {
      ...
      drawCrosshair: function (a, d) {
        ...
        this.crosshair && !1 !== (p(d) || !h)
          ? (h
              ? p(d) && (c = this.isXAxis ? d.plotX : this.len - d.plotY)
              : (c =
                  a &&
                  (this.horiz
                    ? a.chartX - this.pos
                ...
                g ||
                  ...
                  g
                    .attr({
                      stroke:
                        f.color ||
                        (d ? m('#ccd6eb').setOpacity(0.25).get() : '#cccccc'),
  ...
  (function (a, C) {
    ...
    a.PlotLineOrBand.prototype = {
      ...
      renderLabel: function (a, e, c, k) {
        ...
        b ||
          ...
          (b.zIndex = k),
          (this.label = b = g.text(a.text, 0, 0, a.useHTML).attr(b).add()),
          b.css(a.style));
    ...
    a.extend(C.prototype, {
      getPlotBandPath: function (a, e) {
        ...
        if (k && c)
          for (
            a && ((t = k.toString() === c.toString()), (n = 0)), a = 0;
            a < k.length;
            a += 6
          )
            g && c[a + 1] === k[a + 1]
  ...
  (function (a) {
    ...
    a.Tooltip.prototype = {
      ...
      getPosition: function (a, c, k) {
        var b = this.chart,
          ...
          y = function (a, d, b, f) {
            ...
            f < g || f > d - g
              ? (h = !1)
              : (e[a] = f < b / 2 ? 1 : f > d - b / 2 ? d - b - 2 : f - b / 2);
            return h;
          },
          H = function (a) {
            var d = u;
      ...
      refresh: function (a, c) {
        ...
        b.enabled &&
          (clearTimeout(this.hideTimer),
          (this.followPointer = p(n)[0].series.tooltipOptions.followPointer),
              ...
              this.split
                ...
                : (b.style.width ||
                  ...
                  e
                    ...
                    .addClass(
                      'highcharts-color-' + w(n.colorIndex, D.colorIndex)
                    ),
                  e.attr({
          ...
          if (!1 !== a) {
            ...
            e.isHeader
              ? ((u = a.height),
                (I = Math.max(
                  0,
                  Math.min(e.plotX + g.plotLeft - I / 2, g.chartWidth - I)
                )))
              : (I = e.plotX + g.plotLeft - w(f.distance, 16) - I);
            0 > I && (t = !1);
            a =
      ...
      getXDateFormat: function (a, c, k) {
        ...
        return (
          (b ? this.getDateFormat(b, a.x, k.options.startOfWeek, c) : c.day) ||
          c.year
        );
      },
  ...
  (function (a) {
    ...
    a.Pointer.prototype = {
      ...
      getChartCoordinatesFromPoint: function (a, f) {
        ...
        if (g && c)
          return f
            ? { chartX: g.len + g.pos - e, chartY: c.len + c.pos - a.plotY }
        ...
        (G && G.touch) ||
          ...
          10 < this.hasDragged &&
            ...
            G &&
              n &&
              ((g -= h),
              G.attr({ width: Math.abs(g), x: (0 < g ? 0 : g) + h })),
            G &&
              t &&
              ((g = e - x),
              G.attr({ height: Math.abs(g), y: (0 < g ? 0 : g) + x })),
          ...
          if (this.hasDragged || g)
            w(c.axes, function (f) {
              if (
                f.zoomEnabled &&
                l(f.min) &&
                (g || b[{ xAxis: 'zoomX', yAxis: 'zoomY' }[f.coll]])
              ) {
                var c = f.horiz,
      ...
      onContainerMouseMove: function (b) {
        ...
        (!this.inClass(b.target, 'highcharts-tracker') &&
          !f.isInsidePlot(b.chartX - f.plotLeft, b.chartY - f.plotTop)) ||
          f.openMenu ||
        ...
        b.cancelClick ||
          (c && this.inClass(a.target, 'highcharts-tracker')
            ...
            : (p(a, this.getCoordinates(a)),
              b.isInsidePlot(a.chartX - g, a.chartY - e) && B(b, 'click', a)));
      },
      setDOMEvents: function () {
        ...
        a.unbindDocumentMouseUp ||
          (a.unbindDocumentMouseUp = C(c, 'mouseup', b.onDocumentMouseUp));
        a.hasTouch &&
  ...
  (function (a) {
    ...
    F(a.Pointer.prototype, {
      ...
      pinchTranslateDirection: function (a, l, m, r, e, c, k, b) {
        ...
        x
          ? ((z -= 0.8 * (z - k[n][0])), J || (h -= 0.8 * (h - k[n][1])), m())
          : (k[n] = [z, h]);
        H || ((c[n] = A - D), (c[u] = q));
        c = H ? 1 / y : y;
        e[u] = q;
      ...
      pinch: function (a) {
        var p = this,
          ...
          t =
            1 === c &&
            ((p.inClass(a.target, 'highcharts-tracker') && v.runTrackerClick) ||
              p.runChartClick),
          f = {};
        1 < c && (p.initiated = !0);
        ...
        'touchstart' === a.type
          ...
          : w.length &&
            (g ||
              (p.selectionMarker = g = F({ destroy: m, touch: !0 }, v.plotBox)),
      ...
      touch: function (m, p) {
        ...
        1 === m.touches.length
          ? ((m = this.normalize(m)),
            (e = v.isInsidePlot(m.chartX - v.plotLeft, m.chartY - v.plotTop)) &&
            !v.openMenu
  ...
  (function (a) {
    ...
    a.Legend.prototype = {
          ...
          m(
            ...
            function (b) {
              var f = b.checkbox,
                g;
              f &&
                ((g = c + k + f.y + (this.scrollOffset || 0) + 3),
                E(f, {
      ...
      renderItem: function (a) {
        ...
        q.width ||
          G.css({ width: (e.itemWidth || e.width || b.spacingBox.width) - r });
        this.setText(a);
        c = G.getBBox();
        ...
        f &&
          this.itemX - y + q > (J || b.spacingBox.width - 2 * y - e.x) &&
          ((this.itemX = y),
          ...
          m(
            ...
            function (e, n) {
              e.test(f) &&
                ...
                (b[w[n]] = Math.max(
                  b[w[n]],
                  b.legend[(n + 1) % 2 ? 'legendHeight' : 'legendWidth'] +
                    [1, -1, -1, 1][n] * g[n % 2 ? 'x' : 'y'] +
                    v(g.margin, 12) +
                    c[n] +
                    (0 === n ? b.titleOffset + b.options.title.margin : 0)
                ));
            }
          );
      },
      render: function () {
        ...
        u &&
          ...
          /(lth|ct|rth)/.test(a.getAlignment()) &&
            (n = p(n, { y: n.y + c.titleOffset + c.options.title.margin })),
      ...
      handleOverflow: function (a) {
        ...
        d.length = 0;
        a > c && !1 !== y.enabled
          ? ((this.clipHeight = q = Math.max(c - 20 - this.titleHeight - l, 0)),
            ...
            h(q),
            J ||
              ((this.nav = J = e.g().attr({ zIndex: 1 }).add(this.group)),
              (this.up = e
      ...
      scroll: function (a, c) {
        ...
        0 < a &&
          ...
          this.down
            .attr({ fill: a === e ? g.inactiveColor : g.activeColor })
  ...
  (function (a) {
    ...
    b(O.prototype, {
      ...
      init: function (d, b) {
        ...
        this.series = [];
        this.time =
          d.time && a.keys(d.time).length ? new a.Time(d.time) : a.time;
        ...
        k(
          ...
          function (a) {
            ...
            c &&
              ...
              c
                .css({ width: (e.width || h.width + e.widthAdjust) + 'px' })
                .align(b({ y: a + g }, e), !1, 'spacingBox'),
              e.floating ||
                e.verticalAlign ||
                (d = Math.ceil(d + c.getBBox(e.useHTML).height)));
          },
          this
        );
        ...
        if (d)
          for (; b && b.style; )
            b.hcOrigStyle && (a.css(b, b.hcOrigStyle), delete b.hcOrigStyle),
              b.hcOrigDetached &&
                (m.body.removeChild(b), (b.hcOrigDetached = !1)),
              (b = b.parentNode);
        else
          for (; b && b.style; ) {
            m.body.contains(b) ||
      ...
      linkSeries: function () {
        ...
        k(d, function (d) {
          ...
          D(b) &&
            (b = ':previous' === b ? a.series[d.index - 1] : a.get(b)) &&
            b.linkedParent !== d &&
            (b.linkedSeries.push(d),
            (d.linkedParent = b),
            (d.visible = J(d.options.visible, b.options.visible, d.visible)));
        });
      },
      ...
      optionsToObject: function (a) {
        ...
        if (p(a) || null === a) c[g[0]] = a;
          ...
          for (
            ...
            a.length > n &&
            ((e = typeof a[0]),
            'string' === e ? (c.name = a[0]) : 'number' === e && (c.x = a[0]),
            t++);
            f < n;
      ...
      },
      {
          ...
          if (
            ...
            if (l && k > l) {
              ...
              for (d = 0; d < k; d++)
                void 0 !== c[d] &&
                  ((t = { series: z }),
                  z.pointClass.prototype.applyOptions.apply(t, [c[d]]),
        ...
        generatePoints: function () {
          ...
          for (u = 0; u < g; u++)
            (n = k + u),
              y
                ? ((A = new e().init(this, [f[u]].concat(q(h[u])))),
          ...
          if (d && (g !== (c = d.length) || y))
            for (u = 0; u < c; u++)
              u !== k || y || (u += g),
                d[u] && (d[u].destroyElements(), (d[u].plotX = void 0));
          this.data = d;
          this.points = t;
        },
        getExtremes: function (a) {
          ...
          for (t = 0; t < f; t++)
            if (
              ...
              if ((n = A.length))
                for (; n--; ) 'number' === typeof A[n] && (e[h++] = A[n]);
              else e[h++] = A;
          this.dataMin = r(e);
          this.dataMax = F(e);
        },
        translate: function () {
          ...
          for (a = 0; a < q; a++) {
            ...
            var E =
                b &&
                e.stacks[
                  (this.negStacks && C < (t ? 0 : A) ? '-' : '') + this.stackKey
                ],
              F;
            ...
            w.plotX = l = m(
              Math.min(
                Math.max(
                  -1e5,
                  d.translate(B, 0, 0, 0, 1, n, 'flags' === this.type)
                ),
                1e5
              )
            );
            ...
            w.yBottom = p(H)
              ? Math.min(Math.max(-1e5, e.translate(H, 0, 1, 0, 1)), 1e5)
              : null;
        ...
        animate: function (a) {
          ...
          a
            ...
            : ((c = this.sharedClipKey),
              (a = b[c]) && a.animate({ width: b.plotSizeX, x: 0 }, d),
              b[c + 'm'] &&
                b[c + 'm'].animate({ width: b.plotSizeX + 99, x: 0 }, d),
              (this.animate = null));
        },
              ...
              (c = a[d]),
                ...
                f && !c.isNull
                  ? ((f = u(g.symbol, this.symbol)),
                    (y = this.markerAttribs(c, c.selected && 'select')),
                    h
                      ? h[n ? 'show' : 'hide'](!0).animate(y)
                      : n &&
                        (0 < y.width || c.hasImage) &&
                        (c.graphic = h =
                          b.renderer
                            .symbol(f, y.x, y.y, y.width, y.height, q ? g : e)
                            .add(k)),
                    h && h.attr(this.pointAttribs(c, c.selected && 'select')),
        ...
        drawGraph: function () {
          ...
          v(c, function (c, f) {
            var h = c[0],
              e = a[h];
            e
              ? ((e.endX = a.preventGraphAnimation ? null : d.xMap),
                e.animate({ d: d }))
              : d.length &&
        ...
        applyZones: function () {
          ...
          c.length &&
            ...
            v(c, function (c, z) {
              ...
              h = Math.min(
                Math.max(Math.round(y.toPixels(u(c.value, A.max), !0)), 0),
                k
              );
              ...
              p = Math.max(f, h);
              y.isXAxis
                ? ((g = { x: l ? p : D, y: 0, width: H, height: k }),
                  m || (g.x = b.plotHeight - g.x))
                : ((g = { x: 0, y: l ? p : D, width: k, height: H }),
                  m && (g.y = b.plotWidth - g.y));
              l &&
                d.isVML &&
                (g = y.isXAxis
                  ? { x: 0, y: t ? D : p, height: g.width, width: b.chartWidth }
                  : {
      ...
      if (
        ...
        for (G = 0; G < b; G++)
          (h = e[G]),
            ...
            (d = y[d][h]),
            null !== x
              ? ((d.points[z] = d.points[this.index] = [v(d.cumulative, t)]),
                r(d.cumulative) || (d.base = z),
                (d.touched = A.stacksTouched),
                0 < p.index &&
                  !1 === this.singleStacks &&
                  (d.points[z][0] = d.points[this.index + ',' + h + ',0'][0]))
  ...
  (function (a) {
    ...
    v(u.prototype, {
      addPoint: function (a, b, c, f) {
        ...
        c &&
          (e[0] && e[0].remove
            ? e[0].remove(!1)
            : (e.shift(), this.updateParallelArrays(n, 'shift'), q.shift()));
    ...
    v(F.prototype, {
      ...
      remove: function (a) {
        for (
          var c = this.chart, f = this.coll, e = this.series, d = e.length;
          d--;
        ...
        getGraphPath: function (a) {
          ...
          for (c = 0; c < a.length; c++)
            if (
              ...
              v || A(c, c - 1, 'left'),
                (k && !w && v) ||
                  (g.push(a[c]), b.push({ x: c, plotX: t, plotY: q })),
                v || A(c, c + 1, 'right');
          c = l.call(this, g, !0, !0);
          b.reversed = !0;
          k = l.call(this, b, !0, !0);
        ...
        drawGraph: function () {
          ...
          E(B, function (e) {
            var c = e[0],
              k = a[c];
            k
              ? ((k.endX = a.preventGraphAnimation ? null : l.xMap),
                k.animate({ d: l }))
              : ((k = a[c] =
                  a.chart.renderer
                    .path(l)
                    ...
                    .attr({
                      fill: r(
                        e[3],
                        C(e[2]).setOpacity(r(v.fillOpacity, 0.75)).get()
                      ),
                      zIndex: 0,
                    })
                    .add(a.group)),
        ...
        getPointSpline: function (a, F, r) {
          ...
          if (
            ...
            v > a && v > l
              ...
              : v < a && v < l && ((v = Math.min(a, l)), (e = 2 * l - v));
            e > r && e > l
              ? ((e = Math.max(r, l)), (v = 2 * l - e))
              : e < r && e < l && ((e = Math.min(r, l)), (v = 2 * l - e));
            F.rightContX = B;
            F.rightContY = e;
          }
          F = [
    ...
    v(
      ...
      },
      {
        ...
        crispCol: function (a, c, k, b) {
          ...
          this.options.crisp &&
            ((k = Math.round(a + k) + t), (a = Math.round(a) + t), (k -= a));
          b = Math.round(c + b) + n;
        ...
        translate: function () {
          ...
          F(a.points, function (b) {
            ...
            f &&
              Math.abs(h) < f &&
              ((h = f),
              (l = (!g.reversed && !b.negative) || (g.reversed && b.negative)),
              b.y === n && a.dataMax <= n && g.min < n && (l = !l),
              (z = Math.abs(z - t) > f ? e - f : t - (l ? f : 0)));
            b.barX = y;
            b.pointWidth = m;
            b.tooltipPos = c.inverted
              ? [g.len + g.pos - c.plotLeft - k, a.xAxis.len - y - d / 2, h]
        ...
        pointAttribs: function (a, c) {
          ...
          c &&
            ...
            (t =
              a.color ||
              (void 0 !== c && E(t).brighten(a.brightness).get()) ||
              t),
            (f = a[b] || f),
            (u = a[n] || u),
            (g = a.dashStyle || g));
        ...
        drawPoints: function () {
          ...
          F(a.points, function (e) {
            ...
            if (m(e.plotY) && null !== e.y) {
              ...
              f.attr(a.pointAttribs(e, e.selected && 'select')).shadow(
                k.shadow,
                null,
          ...
          B &&
            (a
              ? ((n.scaleY = 0.001),
                ...
                g ? (n.translateX = a - e.len) : (n.translateY = a),
                c.group.attr(n))
              : ((f = c.group.attr(l)),
                c.group.animate(
                  { scaleY: 1 },
    ...
    c(
      ...
      },
      {
          ...
          a ||
            (r(c, function (a) {
              var c = a.graphic,
                f = a.shapeArgs;
              c &&
                (c.attr({ r: a.startR || b.center[3] / 2, start: e, end: e }),
                c.animate(
        ...
        updateTotals: function () {
          ...
          for (a = 0; a < k; a++)
            (f = e[a]),
              (f.percentage = 0 < c && (f.visible || !l) ? (f.y / c) * 100 : 0),
              (f.total = c);
        },
        generatePoints: function () {
        ...
        translate: function (a) {
          ...
          this.getX = function (d, b, c) {
            q = Math.asin(
              Math.min((d - a[1]) / (a[2] / 2 + c.labelDistance), 1)
            );
            return (
              a[0] + (b ? -1 : 1) * Math.cos(q) * (a[2] / 2 + c.labelDistance)
            );
          };
          for (d = 0; d < z; d++) {
            G = H[d];
        ...
        drawPoints: function () {
          ...
          r(a.points, function (b) {
            ...
            if (b.isNull) k && (b.graphic = k.destroy());
              ...
              k
                ? k.setRadialReference(a.center).attr(f).animate(m(l, e))
                : ((b.graphic = k =
                    c[b.shapeType](l)
                  ...
                  k.attr(f).attr({ 'stroke-linejoin': 'round' }).shadow(D, g));
  ...
  (function (a) {
        ...
        for (f = a.length; f--; )
          (g = a[f]),
            (n =
              ...
              2),
            (g.pos = Math.min(Math.max(0, n - g.size * g.align), c - g.size));
        f = a.length;
        for (g = !1; f--; )
          0 < f &&
        ...
        c.dlProcessOptions && c.dlProcessOptions(k),
          ...
          r(m, function (g) {
            ...
            n &&
              ...
              (H = F(u)
                ? l(u, z, e.time)
                : (k[g.formatPrefix + 'Formatter'] || k.formatter).call(z, k)),
              (u = k.style),
              (z = k.rotation),
              (u.color = B(k.color, u.color, c.color, '#000000')),
              'contrast' === u.color &&
                ((g.contrastColor = d.getContrast(g.color || c.color)),
                (u.color =
                  k.inside || 0 > B(g.labelDistance, k.distance) || f.stacking
                    ? g.contrastColor
                    : '#000000')),
            ...
            !h || (n && F(H))
              ? n &&
                ...
                (h
                  ...
                  : ((h = g.dataLabel =
                      z
                        ? d.text(H, 0, -9999).addClass('highcharts-data-label')
                        : d.label(
                            H,
                            0,
                            -9999,
      ...
      var g = this.chart,
        ...
        z =
          ...
          (a.series.forceDL ||
            ...
            (f && g.isInsidePlot(k, q ? f.x + 1 : f.y + f.height - 1, q))),
          ...
          ? ((G = !1),
            ...
            (k = {
              ...
              y:
                f.y +
                c.y +
                { top: 0, middle: 0.5, bottom: 1 }[c.verticalAlign] * f.height,
            }),
            ...
            'left' === d
              ...
              : 'right' === d && ((k.x -= l.width), (k.y -= n ? 0 : l.height)))
          : (b.align(c, null, f), (k = b.alignAttr)),
        G
          ? (a.isLabelJustified = this.justifyDataLabel(b, c, k, l, f, e))
          : B(c.crop, !0) &&
            (z =
    ...
    c.prototype.justifyDataLabel = function (a, b, c, f, e, k) {
      ...
      m = c.y + u;
      0 > m &&
        ('bottom' === l ? (b.verticalAlign = 'top') : (b.y = -m), (t = !0));
      m = c.y + f.height - u;
      m > g.plotHeight &&
        ('top' === l ? (b.verticalAlign = 'bottom') : (b.y = g.plotHeight - m),
        (t = !0));
              ...
              for (
                b.sortByAngle(c, e - 0.5),
                  0 < b.maxLabelDistance &&
                    ...
                    (q = Math.min(d + w + b.maxLabelDistance, f.plotHeight)),
                    r(c, function (a) {
                      0 < a.labelDistance &&
                        a.dataLabel &&
                        ((a.top = Math.max(0, d - w - a.labelDistance)),
                        (a.bottom = Math.min(
                          d + w + a.labelDistance,
                          f.plotHeight
                        )),
                ...
                (k = c[Q]),
                  ...
                  (h = k.labelPos),
                  (z = k.dataLabel),
                  (M = !1 === k.visible ? 'hidden' : 'inherit'),
                  (C = g = h[1]),
                  t &&
                    F(t[q]) &&
                    (void 0 === t[q].pos
                      ? (M = 'hidden')
                      : ((x = t[q].size), (C = k.top + t[q].pos))),
                  delete k.positionIndex,
                  (O = l.justify
                    ? v[0] + (e ? -1 : 1) * (w + k.labelDistance)
                    : b.getX(C < k.top + 2 || C > k.bottom - 2 ? g : C, e, k)),
                  ...
                  B(l.crop, !0) &&
                    ...
                    O - G < m
                      ...
                      : O + G > A - m &&
                        ...
                        (K[1] = Math.max(g, K[1]))),
                    0 > C - x / 2
                      ? (K[0] = Math.max(Math.round(-C + x / 2), K[0]))
                      : C + x / 2 > y &&
                        (K[2] = Math.max(Math.round(C + x / 2 - y), K[2])),
                    (z.sideOverflow = g));
          }),
        ...
        q ||
          (null !== f[0]
            ...
            : ((k = Math.max(b[2] - a[1] - a[3], g)),
              (b[0] += (a[3] - a[1]) / 2)),
          null !== f[1]
            ? (k = Math.max(Math.min(k, b[2] - Math.max(a[0], a[2])), g))
      ...
      for (p = 0; p < l; p++)
        if ((m = a[p]))
          (m.oldOpacity = m.opacity),
            (m.newOpacity = 1),
            m.width ||
              ((v = m.getBBox()), (m.width = v.width), (m.height = v.height));
      a.sort(function (a, b) {
  ...
  (function (a) {
    ...
    D = a.TrackerMixin = {
      ...
      drawTrackerGraph: function () {
        ...
        if (e && !c)
          for (n = e + 1; n--; )
            'M' === f[n] && f.splice(n + 1, 0, f[n + 1] - l, f[n + 2], 'L'),
              ((n && 'M' === f[n]) || n === e) &&
      ...
      showResetZoom: function () {
        ...
        v(this, 'beforeShowResetZoom', null, function () {
          b.resetZoomButton = b.renderer
            ...
            .attr({ align: f.position.align, title: c.resetZoomTitle })
      ...
      pan: function (a, b) {
        ...
        w('xy' === b ? [1, 0] : [1], function (b) {
          ...
          var d = b.horiz,
            ...
            l = Math.min(
              k.dataMin,
              h ? k.min : b.toValue(b.toPixels(k.min) - b.minPixelPadding)
            ),
            h = Math.max(
              k.dataMax,
              h ? k.max : b.toValue(b.toPixels(k.max) + b.minPixelPadding)
            ),
            n = l - g;
          0 < n && ((q += n), (g = l));
          n = q - h;
          ...
          b.series.length &&
            g !== k.min &&
            q !== k.max &&
            (b.setExtremes(g, q, !1, !1, { trigger: 'pan' }), (e = !0));
          c[d] = f;
        });
        e && c.redraw(!1);
      ...
      setState: function (a, b) {
        ...
        if (
          !(
            ...
            !1 === k.enabled ||
            (a && (h || (q && !1 === n.enabled))) ||
            (a && A.states && A.states[a] && !1 === A.states[a].enabled)
          )
        ) {
          ...
          if (this.graphic)
            this.state &&
              ...
              D &&
                this.graphic.animate(
                  D,
                  g(t.options.chart.animation, n.animation, d.animation)
                ),
              m && m.hide();
          else {
            if (a && n) {
              ...
              if (m) m[b ? 'animate' : 'attr']({ x: D.x, y: D.y });
                ...
                d &&
                  ((e.stateMarkerGraphic = m =
                    t.renderer
                      .symbol(d, D.x, D.y, D.width, D.height)
                      .add(e.markerGroup)),
                  (m.currentSymbol = d));
              m && m.attr(e.pointAttribs(this, a));
            }
            m &&
              (m[a && t.isInsidePlot(c, f, t.inverted) ? 'show' : 'hide'](),
              (m.element.point = this));
          }
          (c = k.halo) && c.size
            ? (u ||
                (e.halo = u =
                  t.renderer.path().add((this.graphic || m).parentGroup)),
    ...
    p(t.prototype, {
      ...
      setState: function (a) {
        ...
        if (
          b.state !== a &&
          (w([b.group, b.markerGroup, b.dataLabelsGroup], function (d) {
            d &&
              (b.state && d.removeClass('highcharts-series-' + b.state),
    ...
    w(E.prototype, {
      beforeSetTickPositions: function () {
        ...
        !this.options.overscroll ||
          ...
          !g && m(this.userMin) && (this.min += this.options.overscroll));
        if (n || p) {
          ...
          if (2 < a) {
            ...
            this.options.overscroll &&
              (2 === a
                ? (q = e[1] - e[0])
                : 1 === a
                ? ((q = this.options.overscroll), (e = [e[0], e[0] + q]))
          ...
          b
            ? (this.options.overscroll &&
              ...
              (u = Math.max(
                this.ordinal2lin(Math.min(f, e[e.length - 1]), !0),
                1
              )),
      ...
      getOverscrollPositions: function () {
        var c = this.options.overscroll,
          ...
          g = this.dataMax;
        if (a.defined(e))
          for (b.push(g); g <= this.dataMax + c; ) (g += e), b.push(g);
        return b;
      },
        ...
        w.ordinalPositions
          ? 1 < Math.abs(f) &&
            ...
            f.min >= Math.min(u.dataMin, q) &&
              ...
              b.setExtremes(f.min, f.max, !0, !1, { trigger: 'pan' }),
            (this.mouseDownX = k),
  ...
  (function (a) {
        ...
        if (b) {
          for (; b--; )
            this.isInBreak(e[b], a) &&
              ((g = !0), l || (l = F(e[b].showPoints, this.isXAxis ? !1 : !0)));
          m = g && c ? g && !l : g;
        }
        return m;
      },
    ...
    r(v.prototype, 'init', function (a, c, k) {
      ...
      b.isBroken &&
        ...
        (b.lin2val = function (a) {
          ...
          for (
            e = 0;
            e < b.breakArray.length && !((c = b.breakArray[e]), c.from >= a);
            e++
          )
        ...
        (b.setAxisTranslation = function (a) {
          ...
          b.options.staticScale
            ...
            : b.unitLength && (b.transA *= (A - b.min + y) / b.unitLength);
      ...
      if (c && e && (c.options.breaks || e.options.breaks))
        for (; l--; )
          (g = b[l]),
            (f = null === g.y && !1 === m),
            f ||
              (!c.isInAnyBreak(g.x, !0) && !e.isInAnyBreak(g.y, !0)) ||
              (b.splice(l, 1), this.data[l] && this.data[l].destroyElements());
    });
    ...
    a.Series.prototype.gappedPath = function () {
      ...
      if (e && 0 < b)
        for (
          'value' !== this.options.gapUnit && (e *= this.closestPointRange),
            c && c > e && (e = c);
          b--;
          ...
          k[b + 1].x - k[b].x > e &&
            ...
            this.options.stacking &&
              ((c = g.stacks[this.stackKey][c] =
                new a.StackItem(g, g.options.stackLabels, !1, c, this.stack)),
              (c.total = 0)));
    ...
    g.groupData = function (a, b, c, e) {
      ...
      for (H; H <= n; H++) {
        ...
        if (r) {
          ...
          for (A = 0; A < D; A++)
            (C = I[r[A]]),
              v(C) ? t[A].push(C) : null === C && (t[A].hasNulls = !0);
        } else
          (A = p ? b[H] : null),
            v(A) ? t[0].push(A) : null === A && (t[0].hasNulls = !0);
      }
      return [k, m, h];
    };
        ...
        translate: function () {
          ...
          C(a.points, function (m) {
            C([m.open, m.high, m.low, m.close, m.low], function (r, e) {
              null !== r &&
                (w && (r = a.modifyValue(r)), (m[p[e]] = l.toPixels(r, !0)));
            });
        ...
        drawPoints: function () {
          ...
          C(a.points, function (m) {
            var p,
              ...
              b = !c;
            void 0 !== m.plotY &&
              (c || (m.graphic = c = l.renderer.path().add(a.group)),
    ...
    r(
      ...
      }),
      {
        pointAttribs: function (a, r) {
          ...
          l.fill =
            a.options.color || (w ? v.upColor || this.color : this.color);
        ...
        drawPoints: function () {
          ...
          E(a.points, function (l) {
            var p = l.graphic,
              ...
              t = !p;
            void 0 !== l.plotY &&
              (p || (l.graphic = p = m.renderer.path().add(a.group)),
              p
        ...
        drawPoints: function () {
          ...
          for (p = c.length; p--; )
            (q = c[p]),
              ...
              (l = q.plotY),
              void 0 !== l &&
                (l = q.plotY + f - (void 0 !== A && A * t.stackDistance)),
              ...
              void 0 !== l && 0 <= g && !v
                ? (A ||
                    ((A = q.graphic =
                      b
                        .label('', null, null, u, null, null, t.useHTML)
                  ...
                  (u = { y: l, anchorY: y }),
                  t.allowOverlapX && ((u.x = g), (u.anchorX = q.anchorX)),
                  A.attr({ text: q.options.title || t.title || 'A' })[
                    A.isNew ? 'attr' : 'animate'
                  ](u),
                  t.allowOverlapX ||
                    (B[q.plotX]
                      ? (B[q.plotX].size = Math.max(B[q.plotX].size, A.width))
                      : (B[q.plotX] = {
                          align: 0,
                          size: A.width,
                          target: g,
                  ...
                  (q.tooltipPos = e.inverted
                    ? [w.len + w.pos - e.plotLeft - l, this.xAxis.len - g]
                    : [g, l + w.pos - e.plotTop]))
          ...
          r(a, function (c) {
            ...
            b &&
              F(b.element, 'mouseover', function () {
                0 < c.stackIndex &&
                  !c.raised &&
                  ((c._y = b.y), b.attr({ y: c._y - 8 }), (c.raised = !0));
                r(a, function (a) {
                  a !== c &&
                    a.raised &&
                    a.graphic &&
  ...
  (function (a) {
    ...
    C.prototype = {
      ...
      render: function () {
        ...
        this.track = a
          ...
          .attr({ x: 0, r: b.trackBorderRadius || 0, height: c, width: c })
          .add(e);
        this.track.attr({
    ...
    g(F.prototype, 'init', function (a) {
      ...
      b.options.scrollbar &&
        ...
        (b.scrollbar = new C(b.chart.renderer, b.options.scrollbar, b.chart)),
        E(b.scrollbar, 'changed', function (a) {
          ...
          (b.horiz && !b.reversed) || (!b.horiz && b.reversed)
            ...
            : ((e = c + f * (1 - this.from)), (c += f * (1 - this.to)));
        ...
        this.horiz
          ? (f.position(
              ...
              this.top +
                ...
                (this.opposite ? 0 : e + this.axisTitleMargin + this.offset),
              this.width,
              this.height
            ),
            (e = 1))
          : (f.position(
              this.left +
                ...
                (this.opposite ? e + this.axisTitleMargin + this.offset : 0),
              this.top,
              this.width,
              this.height
            ),
  ...
  (function (a) {
    ...
    C.prototype = {
        ...
        if (!this.hasDragged || w(e)) {
          ...
          t < r
            ...
            : w(y) &&
              ...
              (this.grabbedLeft
                ? (e = m.toPixels(c - y, !0))
                : this.grabbedRight && (f = m.toPixels(b + y, !0)));
          ...
          q &&
            ...
            this.navigatorOptions.handles.enabled &&
              (this.drawHandle(e, 0, g, p), this.drawHandle(z, 1, g, p)));
          this.scrollbar &&
            (g
              ? ((g = this.top - k),
                (h =
                ...
                (k = l + 2 * k))
              : ((g = this.top + (q ? this.height : -k)), (h = this.left - k)),
      ...
      addMouseEvents: function () {
        ...
        b &&
          (f.push(E(e, 'touchmove', g), E(e.ownerDocument, 'touchend', k)),
          ...
          : ((a = l - f - k / 2),
            0 === b
              ...
              : 2 === b &&
                ...
                ((a = g - k),
                d.reversed
                  ? ((a -= k), (n = this.getUnionExtremes().dataMin))
      ...
      onMouseUp: function (a) {
        ...
        ((!this.hasDragged || (e && e.hasDragged)) &&
          ...
          this.zoomedMax === this.size && (g = d ? e.dataMin : e.dataMax),
          ...
          w(c.min) &&
            b.xAxis[0].setExtremes(
              ...
              { trigger: 'navigator', triggerOp: 'navigator-drag', DOMEvent: k }
            ));
        'mousemove' !== a.DOMType &&
          (this.grabbedLeft =
            this.grabbedRight =
      ...
      init: function (a) {
        ...
        a.inverted &&
          (a.extraMargin.type = l.opposite ? 'marginRight' : 'plotLeft');
        a.isDirtyBox = !0;
        l.navigatorEnabled
          ? ((l.xAxis = new F(
              a,
      ...
      destroy: function () {
        this.removeEvents();
        this.xAxis &&
          (B(this.chart.xAxis, this.xAxis), B(this.chart.axes, this.xAxis));
        this.yAxis &&
          (B(this.chart.yAxis, this.yAxis), B(this.chart.axes, this.yAxis));
        v(this.series || [], function (a) {
          a.destroy && a.destroy();
        });
        v(
    ...
    C.prototype = {
      clickButton: function (a, c) {
        ...
        if (null !== d && null !== p) {
          ...
          if ('month' === r || 'year' === r)
            m
              ? ((r = { range: l, max: h, chart: k, dataMin: d, dataMax: p }),
      ...
      updateButtonStates: function () {
        ...
        e(this.buttonOptions, function (a, b) {
          ...
          f - 36e5 <= 864e5 * { month: 31, year: 366 }[k] * q + a
            ...
            : 'ytd' === k
            ? ((e = n - d + a === f), (v = !b))
            : 'all' === k && ((e = c.max - c.min >= m - l), (x = !b && h && e));
          k = !t && (u || z || x || g);
          q = (b && e) || (e && !h && !v);
          k ? (A = 3) : q && ((h = !0), (A = 2));
      ...
      drawInput: function (a) {
        function e() {
          ...
          c !== v.previousValue &&
            ...
            b(c) &&
              (k.time.useUTC || (c += 6e4 * new Date().getTimezoneOffset()),
              u
                ? c > f.maxInput.HCTime
                  ? (c = void 0)
                  : c < g && (c = g)
                ...
                : c > e && (c = e),
              void 0 !== c &&
                d.setExtremes(u ? c : d.min, u ? d.max : c, void 0, void 0, {
      ...
      render: function (a, b) {
        ...
        if (!1 !== h.enabled) {
          L ||
            ((c.group = L =
              g.g('range-selector-group').attr({ zIndex: 7 }).add()),
            (c.buttonGroup = E = g.g('range-selector-buttons').add(L)),
            (c.zoomText = g
          ...
          E.align(
            { y: u.y, width: E.getBBox().width, align: u.align, x: S },
            !0,
            f.spacingBox
          );
          c.group.placed = ca;
          ...
          !1 !== B &&
            ...
            'left' === v.align
              ? (S = C)
              : 'right' === v.align && (S = -Math.max(f.axisOffset[1], -U)),
            p.align(
              {
                y: v.y,
            ...
            (v.align === u.align ||
              (q + S > k && k + d > q && ba < X + p.getBBox().height)) &&
              p.attr({
                translateX:
                  p.alignAttr.translateX + (f.axisOffset[1] >= -U ? 0 : -U),
          ...
          'bottom' === W &&
            ((Z =
              aa && 'bottom' === aa.verticalAlign && aa.enabled && !aa.floating
          ...
          if ('top' === W)
            m && (R = 0),
              f.titleOffset && (R = f.titleOffset + f.options.title.margin),
          ...
          !1 !== B &&
            ((c.minInput.style.marginTop = c.group.translateY + 'px'),
      ...
      destroy: function () {
        ...
        a.objectEach(
          ...
          function (a, c) {
            a &&
              'chart' !== c &&
              (a.destroy ? a.destroy() : a.nodeType && B(this[c]));
  ...
  (function (a) {
      ...
      e(E) &&
        (d.horiz
          ...
          : l(D, function (a) {
              ...
              if (w < z || w > z + d.height)
                p
                  ? (w = A = Math.min(Math.max(z, w), d.top + d.height))
                  : (b = !0);
              b || C.push('M', x, w, 'L', y, A);
            }));
    ...
    A(F.prototype, 'drawCrosshair', function (a, b, c) {
      ...
      if (
        ...
        k
          ? ((q = v ? c.plotX + e : b.chartX), (l += d ? 0 : this.height))
          : ((q = d ? this.width + e : 0), (l = v ? c.plotY + l : b.chartY));
        r ||
          f.formatter ||
        ...
        for (
          c = this.processedXData,
            ...
            this.pointArrayMap &&
              ...
              -1 === b && (b = B(this.pointValKey || 'y', this.pointArrayMap))),
            a = 0;
          a < k - g;
          a++
        )
